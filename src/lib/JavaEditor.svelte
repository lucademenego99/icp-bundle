...
<script lang="ts">
    ...
    import JavaWorker from "../modules/workers/javaWorker?url";
    ...
    onMount(() => {
        ...
        // const teaworker = new SharedWorker("/utils/java/teaWorker.js");
        // teaworker.port.start();
        ...
        let workerjob = `
                ...
                const workerrun = new SharedWorker(URL.createObjectURL(workerBlob));


        // console.log("TEAWORKER PORT", teaworker.port);
